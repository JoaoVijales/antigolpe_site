...
<div id="loginPopup" class="popup">
  <div class="popup-content">
    <?php // TODO: Refatorar - A estrutura externa deste popup (classes .popup, .popup-content, .close-popup, .popup-title, .divider, .google-btn, .login-link/signup-link) é duplicada em register.php e forgot_password.php. Considerar criar um componente de popup genérico ou auth_popup_container para reutilizar esta estrutura.
     ?>
